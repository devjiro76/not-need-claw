...
You want to build a product but don't know what to build. Or you have a business and need to understand what your customers are struggling with. This workflow uses the Last 30 Days skill to mine Reddit and X for real pain points, then has your AI agent build solutions to those problems.
...
- Takes it a step further: ask your AI agent to build an MVP that solves one of those challenges
...
- [Last 30 Days](https://github.com/mvanhorn/last30days-skill/) skill by Matt Van Horde (can be used as an MCP server or integrated directly)
- Telegram or Discord integration for receiving research reports

## How to Set It Up

1. Install the Last 30 Days skill. You can set it up as an MCP server or integrate it directly into your agent's toolchain:
```text
# Clone and configure the skill
git clone https://github.com/mvanhorn/last30days-skill/
# Follow the repository's setup instructions for your agent platform
```
...
3. Pick a pain point and have your AI agent build a solution:
```text
...
```text
"Use the Last 30 Days skill to research challenges people are having with AI coding agents."
...
→ "Build me a simple web app that makes AI agent setup easier with a guided wizard."

The AI agent builds the app. You ship it. You have a product.
```
...
- You don't need to be technical. The AI agent does the research AND the building.
- Schedule weekly research to stay on top of evolving pain points in your market.

## Based On

Inspired by [Alex Finn's video on life-changing AI agent use cases](https://www.youtube.com/watch?v=41_TNGDDnfQ) and the [Last 30 Days skill](https://github.com/mvanhorn/last30days-skill/) by Matt Van Horde.
