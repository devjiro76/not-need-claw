...
Before your AI agent starts building anything new, it automatically checks whether the idea already exists across GitHub, Hacker News, npm, PyPI, and Product Hunt — and adjusts its approach based on what it finds.
...
2. Add the MCP server to your agent's config (e.g., `claude_desktop_config.json`, `mcp.json`, or equivalent):
...
3. Add this to your AI agent instructions:
...
The AI agent runs `idea_check("AI code review tool")` and responds:
...
- **Batch validation**: Before a hackathon, give your AI agent a list of 10 ideas and have it rank them by `reality_signal` — lowest score = most original opportunity.
