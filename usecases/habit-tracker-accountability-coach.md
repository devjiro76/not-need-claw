...
This use case turns an AI agent into a proactive accountability partner that checks in with you daily via Telegram or SMS.
...
- File system or database access for storing habit data (e.g., a local JSON file or SQLite database)
...
Mark completed habits with checkmark and missed with X.
```
