...
## What It Does
This use case uses a Todoist integration to:
...
## Skills you Need
You don't need a pre-built skill. Simply prompt your AI agent to create the bash scripts described in the **Setup Guide** below. Since the agent can manage its own filesystem and execute shell commands, it will effectively "build" the skill for you upon request.

## Detailed Setup Guide

### 1. Configure Todoist
Create a project (e.g., "Agent Workspace") and get its ID. Create sections for different states:
- `In Progress`
- `Waiting`
- `Done`

### 2. Implementation: The "Agent-Built" Skill
Instead of installing a skill, you can ask your AI agent to create these scripts for you. Each script handles a different part of the communication with the Todoist API.
