...
This workflow has your AI agent send you a fully customized morning briefing every day at a scheduled time, covering news, tasks, ideas, and proactive recommendations.
...
- A web research tool or API for social media trend research (optional)
- Scheduling mechanism (cron job, task scheduler, or agent framework with built-in scheduling)

## How to Set It Up

1. Connect your AI agent to your messaging platform and task manager.
...
3. The agent will schedule this automatically. Verify it's working by checking your messages the next morning.
