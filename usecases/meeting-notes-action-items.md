...
- Jira, Linear, Todoist, or Notion integration (for task creation) — via their REST APIs or MCP servers
- Slack or Discord integration (for posting summaries) — via webhook or bot API
